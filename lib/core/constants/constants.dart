...
const List<String> defaultImage = ["https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQHFlj9YsohIHRVqtGnJjz8IgrHuGZyz7D9OA&s"];

const Color primaryColor = Color(0xFFFFFFFF);
const Color surfaceColor = Color(0xFF121212);
const Color surfaceContainer = Color(0xFF232122);
const Color surfaceContainerHigh = Color(0xFF353334);

const Color onPrimaryColor = surfaceColor;
const Color onSurfaceColor = primaryColor;
const Color onSurfaceVariant = primaryColor;

const widgetDuration = 750;
const widgetDelay = 150;
